...
//#region node_modules/qr-scanner/qr-scanner.min.js
var e = class e {
	...
	static async createQrEngine(a) {
		...
		a = () => Promise.resolve().then(() => qr_scanner_worker_min_exports).then((c) => c.createWorker());
...
//#endregion
//#region node_modules/qr-scanner/qr-scanner-worker.min.js
var qr_scanner_worker_min_exports = /* @__PURE__ */ __exportAll({ createWorker: () => createWorker });
